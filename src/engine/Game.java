...
public class Game {
	...
	/////////////hasEffect Helper............(Search for Effect)
			...
			if (x >= 0 && x < BOARDHEIGHT && y >= 0 && y < BOARDWIDTH) {
				...
				if (o != null) {
					if (o instanceof Cover) {
						...
						boolean friendly = ((firstPlayer.getTeam().contains(getCurrentChampion())//////////isFriendly
	...
	private void cleanup(ArrayList<Damageable> targets) {//////////cleanup Helper..........removes dead
		for (Damageable c : targets) {
			if (c.getCurrentHP() == 0) {
				...
				while (!turnOrder.isEmpty()) {/////////////////////Remove from turnOrder
				...
				while (!temp.isEmpty())
					turnOrder.insert(temp.remove(0));////////////////end
	...
	private void updateTimers(Champion current) {////////////update Helper........updates Champions
		int i = 0;
